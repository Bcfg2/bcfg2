...
class Source(Debuggable):
    ...
    def process_files(self, dependencies,
                      provides, recommends=None):
    ...
    def is_package(self, metadata, package):  # pylint: disable=unused-argument
